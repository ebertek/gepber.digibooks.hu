...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="hu-HU" lang="hu-HU">
  ...
  <body style="font-size: 11px; font-family: Verdana, 'Bitstream Vera Sans', 'DejaVu Sans', Tahoma, Geneva, Arial, sans-serif; color: #636466; -webkit-font-smoothing: antialiased;">
    ...
    <div style="font-size: 11px; font-family: Verdana, 'Bitstream Vera Sans', 'DejaVu Sans', Tahoma, Geneva, Arial, sans-serif; color: #636466; -webkit-font-smoothing: antialiased;">
      ...
      <div style="color: #636466;">
        <?php if ($location == 'D') { echo('<p style="margin: 0px;">4031 Debrecen • Richter Gedeon u. 0367/71 hrsz.</p>'); } ?>
      ...
      <div>
        <a href="http://www.ipaf.org"><img id="ipaf" style="width: 48px; border: 0px; vertical-align: middle;" src="https://www.gepber.hu/img/ipaf.jpg" alt="IPAF Member" /></a>
      ...
      <div style="color: #999999;">
        ...
        <p style="margin: 0px;">&nbsp;</p>
        <p style="margin: 0px;"><i>Gépbér Hungária Kft. general terms and condition contain a limitation of liability and are applicable to all quotations, contracts and other legal relationships with Gépbér Hungária Kft. These general terms and conditions can be accessed, printed and downloaded at <a href="https://www.gepber.hu/">www.gepber.hu</a>.</i></p>
